...
class StackUser(resource.Resource):
    ...
    def __init__(self, name, json_snippet, stack, version=0, load_from_db=False):
        super(StackUser, self).__init__(name, json_snippet, stack, version=version, load_from_db=load_from_db)
